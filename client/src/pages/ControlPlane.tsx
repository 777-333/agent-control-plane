    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6">
        <Surface className="min-w-0 p-6">
          ...
          <div className="mt-5 grid gap-4 [grid-template-columns:minmax(0,1fr)] 2xl:[grid-template-columns:repeat(auto-fit,minmax(44rem,1fr))]">
                ...
                <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                  ...
                  <div className="grid min-w-[230px] gap-2 rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-600">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        type="button"
                        title="Agent-ID kopieren (für die Anbindung im Agenten-Code)"
                        className="rounded-md border border-slate-200 bg-white px-2 py-0.5 font-mono text-xs font-semibold text-slate-950 transition hover:bg-slate-100"
                        onClick={async () => {
                          await navigator.clipboard.writeText(String(agent.id));
                          toast.success(`Agent-ID #${agent.id} kopiert`);
                        }}
                      >
                        #{agent.id}
                      </button>
